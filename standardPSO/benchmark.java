...
public class benchmark {
	...
	static final public String DEFAULT_FILE_BIAS = "F:/PSOData/supportData/fbias_data.txt";
	...
	//		for(int f=1; f<= NUM_TEST_FUNC; f++){
	//			benchmark theBenchmark = new benchmark(f);
	//			System.out.println("Function " + f + " " + theBenchmark.runTest(f));
	//		}
	//	}
	...
	public benchmark (int f) {
		this(DEFAULT_FILE_BIAS, f);
	}
	benchmark (String file_bias, int f) {
		...
		int func_num = f;
		int num_test_points = 1;
		int test_dimension = 30;

		double[] test_f = new double[num_test_points];
		//		double[][] test_x = new double[num_test_points][test_dimension];
		test_x = new double[num_test_points][test_dimension];

		String file_test = "F:/PSOData/testData/test_data_func" + func_num + ".txt";

		
		// Create the test function object

		if (func_num == 1){
			aFunc = new F01_shifted_sphere (test_dimension, m_biases[func_num-1]);
		}
		else if (func_num == 2){
			aFunc = new F02_shifted_schwefel (test_dimension, m_biases[func_num-1]);
		}
		else if (func_num == 3){
			aFunc = new F03_shifted_rotated_high_cond_elliptic (test_dimension, m_biases[func_num-1]);
		}
		//		else if (func_num == 4){
		//			aFunc = new F04_shifted_schwefel_noise (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 5){
		//			aFunc = new F05_schwefel_global_opt_bound (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 6){
		//			aFunc = new F06_shifted_rosenbrock (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 7){
		//			aFunc = new F07_shifted_rotated_griewank (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 8){
		//			aFunc = new F08_shifted_rotated_ackley_global_opt_bound (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 9){
		//			aFunc = new F09_shifted_rastrigin (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 10){
		//			aFunc = new F10_shifted_rotated_rastrigin (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 11){
		//			aFunc = new F11_shifted_rotated_weierstrass (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 12){
		//			aFunc = new F12_schwefel (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 13){
		//			aFunc = new F13_shifted_expanded_griewank_rosenbrock (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 14){
		//			aFunc = new F14_shifted_rotated_expanded_scaffer (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 15){
		//			aFunc = new F15_hybrid_composition_1 (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 16){
		//			aFunc = new F16_rotated_hybrid_composition_1 (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 17){
		//			aFunc = new F17_rotated_hybrid_composition_1_noise (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 18){
		//			aFunc = new F18_rotated_hybrid_composition_2 (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 19){
		//			aFunc = new F19_rotated_hybrid_composition_2_narrow_basin_global_opt (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 20){
		//			aFunc = new F20_rotated_hybrid_composition_2_global_opt_bound (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 21){
		//			aFunc = new F21_rotated_hybrid_composition_3 (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 22){
		//			aFunc = new F22_rotated_hybrid_composition_3_high_cond_num_matrix (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 23){
		//			aFunc = new F23_noncontinuous_rotated_hybrid_composition_3 (test_dimension, m_biases[func_num-1]);
		//		}
		//		else if (func_num == 24){
		//			aFunc = new F24_rotated_hybrid_composition_4 (test_dimension, m_biases[func_num-1]);
		//		}
		//		else 
		//			aFunc = new F25_rotated_hybrid_composition_4_bound (test_dimension, m_biases[func_num-1]);
	...
	public double runTest(double[] positions) {
		return runTest(0, positions);
	}
	public double runTest(int func_num, double[] positions) {
		double result = 0;
//		System.out.print("function number " + func_num);
		if (func_num == 0) {
...
//			System.out.println("Calculating function");
	...
	public double runTest(int func_num) {
		double result = 0;
		if (func_num == 0) {
			for (int i = 1 ; i <= NUM_TEST_FUNC ; i ++)
				runTest(i);
	...
	static public double ackley(double[] x) {
		...
		double part1 = -20.0 * Math.exp(-0.2 * Math.sqrt(sum1 / ((double )x.length)));
		double part2 = - Math.exp(sum2 / ((double )x.length));
		double part3 = 20.0;
		double part4 = Math.E;
